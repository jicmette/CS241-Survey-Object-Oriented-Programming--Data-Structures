...
goat= players[(players.points > 2000) & (players.assists > 400) & (players.steals > 200)]
goat = goat[goat.fgSuccessPercent > .5]
print(goat[["playerID", "firstName", "lastName", "points", "assists", "steals", "blocks", "fgSuccessPercent", "ftSuccessPercent", "threeSuccessPercent"]].sort_values("points", ascending=False))

...
class Target(Ovni):
    ...
    def is_off_screen(self, screen_width, screen_height):
        return super().is_off_screen(screen_width, screen_height)
...
class Target_Safe(Target):
    ...
    def draw(self):
        arcade.draw_rectangle_filled(self.center.x, self.center.y, TARGET_SAFE_DIM, TARGET_SAFE_DIM, TARGET_SAFE_COLOR)
...
class Game(arcade.Window):
    ...
    def create_target(self):
        ...
        self.my_target = Target_Standard()
        self.targets.append(self.my_target)
        self.my_target = Target_Strong()
        self.targets.append(self.my_target)
        self.my_target = Target_Safe()
        self.targets.append(self.my_target)
